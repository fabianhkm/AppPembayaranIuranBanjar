...
import id.fabian.pembayaraniuranbanjar.database.wargaEntity;
    ...
    public class MainActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            cbSampah = findViewById(R.id.checkBoxSampah);
            cbDesa = findViewById(R.id.checkBoxDesa);
...
//                wargaentity.NIK_KITAS = EditNIK.getText().length();
                    ...
                    chekNIK = EditNIK.getText().toString();
...
//                    TextView checkAngkel = (TextView) findViewById(R.id.jumlahAngkel);
                    ...
                    }else if (EditNIK.getText().toString().length()==0){
                        EditNIK.setError("NIK Wajib Diisi");
                    }else if (EditAlm.getText().toString().length()==0){
                        EditAlm.setError("Alamat Wajib Diisi");
                    }
//                    else if (checkAngkel == null){
//                        checkAngkel.setError("Jumlah Anggota Wajib Diisi");
//                    }
                    else {
                        stat = true;
                    }
                    ...
                    if (cbDesa.isChecked() || cbSampah.isChecked()){
                        statCheckBox = true;
                    }else{
                        statCheckBox = false;
...
//                        Toast.makeText(getApplicationContext(),"" + editTextnama.getText().toString(), Toast.LENGTH_SHORT).show();
                        ...
                        if (isEdit){
                            database.wargaDao().update(idWarga, EditNama.getText().toString(), EditAlm.getText().toString(),  Integer.parseInt(EditNIK.getText().toString()), radiobtnchoose.getText().toString(),getCheckedBoxValue(),jumlahanggota);
                        }else {
...
//                float computeProgress = progress;
                    textViewAngkelValue.setText(String.format((progress +1) + " Orang"));
