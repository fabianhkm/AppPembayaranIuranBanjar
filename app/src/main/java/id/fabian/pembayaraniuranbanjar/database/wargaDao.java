...
public interface wargaDao {
    ...
    //edit
    @Query("UPDATE wargaEntity SET Nama=:Nama, Alamat=:Alamat, NIK=:NIK, JenisKelamin=:JenisKelamin, Iuran=:Iuran, AnggotaKK=:AnggotaKK WHERE idWarga=:idWarga")
    void update(int idWarga, String Nama, String Alamat, Integer NIK , String JenisKelamin, String Iuran, Integer AnggotaKK);
